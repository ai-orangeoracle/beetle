...
export function ThemeAndBaseline({ children }: PropsWithChildren) {
  ...
  const theme = useMemo(() => createAppTheme(themeMode, themeBrand), [themeMode, themeBrand])
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box
        ...
        sx={{
          ...
          borderBottom: '168px solid color-mix(in srgb, var(--primary) 5%, transparent)',
          top: '26%',
          right: '18%',
      ...
      <Box
        ...
        sx={{
          ...
          borderBottom: '120px solid color-mix(in srgb, var(--accent) 5%, transparent)',
          bottom: '22%',
          left: '12%',
